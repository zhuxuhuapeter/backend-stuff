...
db_server_port = urllib.parse.quote_plus(str(os.environ.get('db_server_port', '5000')))
database_name = os.environ.get('database_name', 'fast_api')
...
DATABASE_URL = 'mariadb://{}:{}@{}:{}/{}?sslmode={}'.format(db_username, db_password, host_server, db_server_port, database_name, ssl_mode)
